...
export function signOpen(signedMsg, publicKey) {
...
export function signDetachedVerify(msg, sig, publicKey) {
...
export function signKeyPairFromSecretKey(secretKey) {
...
export function signKeyPairFromSeed(seed) {
